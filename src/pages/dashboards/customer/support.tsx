...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We accept major credit cards and bank transfers. Payment is typically 50% upfront and 50% upon project completion. For larger projects, we can arrange milestone-based payments."
    }
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Get help with your projects and account</p>
      </div>
